                  ...
                  <div class="main-menu stellarnav desktop light">
                    <ul class="menu-list list-unstyled">
                      ...
                      <li class="menu-item has-sub">
                        ...
                        <ul class="submenu">
                          <li>
                            <a href="about.php" class="text-uppercase">About</a>
                          </li>
                          <li>
                            <a href="shop.php" class="text-uppercase">Shop</a>
                          </li>
                          <li>
                            <a href="blog.php" class="text-uppercase">Blog</a>
                          </li>
                          <li>
                            <a href="styles.php" class="text-uppercase">Styles</a>
                          </li>
                          <li>
                            <a href="single-product.php" class="text-uppercase">Single Product</a>
                          </li>
                          <li>
                            <a href="login.php" class="text-uppercase">Single Post</a>
                          </li>
                          <li>
                            <a href="cart.php" class="text-uppercase">Contact</a>
                          </li>
                        </ul>
                      </li>
                      <li class="menu-item">
                      ...
                      <li class="menu-item">
                        <a href="cart.php" class="text-uppercase item-anchor">Contact</a>
                      </li>
                    </ul>
                  </div>
                  <div class="hamburger">
            ...
            <div class="row d-flex flex-wrap">
              <div class="footer-menu col-md-2 col-sm-6 col-xs-6">
                ...
                <ul class="list-unstyled">
                  ...
                  <li>
                    <a href="single-product.php">Products</a>
                  </li>
                  <li>
                    <a href="#">Blog</a>
                  </li>
              ...
              <div class="footer-menu col-md-4 col-sm-6 col-xs-6">
                ...
                <div class="footer-post d-flex flex-wrap">
                  ...
                  <div class="text-block">
                    <a href="single-product.php">Diamond Crescent Silver Ring</a>
                ...
                <div class="footer-post d-flex flex-wrap">
                  ...
                  <div class="text-block">
                    <a href="single-product.php">Diamond Crescent Golden Ring</a>
                ...
                <div class="footer-post d-flex flex-wrap">
                  ...
                  <div class="text-block">
                    <a href="single-product.php">Diamond Crescent Curve Ring</a>
